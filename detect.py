...
#flags.DEFINE_boolean('crop', False, 'count objects within images')
...
def main(_argv):
    ...
    if FLAGS.lpr:
                ...
                try:
                    ...
                    pass
                # ocr
                jdict = crop_objects(cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB), pred_bbox, crop_path, allowed_classes)
